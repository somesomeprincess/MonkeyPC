...
public class Wendingxing129Test {
...
//            Class<?> c = Class.forName("java.lang.String");
    ...
    public void testClock(){
        openAppByText("时钟");
        waitByText("闹钟").click();
        waitByDesc("添加闹钟").click();
        UiObject2 hour = waitByRes("com.android.deskclock:id/loopView_hour");
        hour.swipe(Direction.UP,0.5f);
        waitByText("确定").click();
    }
    ...
    public void testTakePic(){
        ...
        UiObject2 object2 =mDevice.wait(Until.findObject(By.res("org.codeaurora.snapcam:id/shutter_button")),timeout);
