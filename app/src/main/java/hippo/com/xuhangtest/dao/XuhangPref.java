 ...
 */
package hippo.com.xuhangtest.dao;

import android.content.SharedPreferences;
import hippo.com.xuhangtest.XuhangAPP;

public class XuhangPref {
	public static final String GT_SP_NAME = "xuhang_SharedPreferences";
...
//	public static final String OP_PERF_DETAIL_WARN_AREA_FOLD = "op_perf_detail_wf";
	...
	private static SharedPreferences gt_SP =
			XuhangAPP.getContext().getSharedPreferences(GT_SP_NAME, 0);
	
	public static SharedPreferences getXuhangPref()
	{
		return gt_SP;
	}
}
